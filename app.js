...
app.get("/", (req, res) =>{
  ...
  Blog.find({}, (err, posts) =>{
    if(err){
      ...
      res.render('home', {viewHomeContent: homeStartingContent, viewBlogPost: posts});
...
app.get("/about", (req, res) =>{
  res.render('about', {viewAboutContent: aboutContent});
});
...
app.get("/posts/:postId", (req, res) => {
  ...
  // set postName to kebab case
  // postName = _.kebabCase(postName);
  
  const requestedPostId = req.params.postId;

  Blog.findOne({_id: requestedPostId}, (err, post) =>{
    res.render("post", {
      webPostTitle: post.title,
      webPostContent: post.content
    });
  });
